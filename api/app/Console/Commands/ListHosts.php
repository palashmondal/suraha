...
/**
 * Every Suraha subdomain label, one per line: each provisioned upazila and each district that has
 * one (the DC dashboards). `scripts/dev.sh` feeds this into /etc/hosts,
...
class ListHosts extends Command
{
    ...
    protected $description = 'List every Suraha subdomain label — upazilas, districts (one per line).';
